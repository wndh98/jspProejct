				...
				<div class="board_content">
					...
					<form action="/admin/product/piWrite.do" method="post">
						...
						<table class="boardForm">
							...
							<tr>
								<th>옵션</th>
								<td><input type="checkbox" value="1" name="piHit"><label>HIT</label>
								</td>
							</tr>
							<tr>
								<th>제품명</th>
								<td><input type="text" style="width: 100%" name="piName"></td>

							</tr>
							<tr>
								<th>소비자가격</th>
								<td><input type="number" name="piCprice"></td>
							</tr>
							<tr>
								<th>제품가격</th>
								<td><input type="number" name="piPrice"></td>
							</tr>
							<tr>
								<th>할인가</th>
								<td><input type="number" name="piSailPrice"></td>
							</tr>
							<tr>
								<th>배송비</th>
								<td><input type="number" name="piDelivery"></td>
							</tr>
							<tr>
								<th>재고</th>
								<td><input type="number" name="piCount"></td>
							</tr>
						</table>
