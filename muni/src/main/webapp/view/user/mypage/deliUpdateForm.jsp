	...
	<div id="container">
		<div class="contents">
			...
			<div class="myshopArea">
				...
				<form action="/user/mypage/deliUpdate.do" method="post">
					<input type="hidden" name="udNum" value="${deli.udNum}">
					<input type="hidden" name="userId" value="${deli.userId}">
						...
						<div class="board_content">
							<table class="boardForm">
								...
								<tr>
									<th>배송지명</th>
									<td>
										<input type="text" name="udSubject" required value="${deli.udSubject}">
									</td>
								</tr>
								<tr>
									<th>수취인명</th>
									<td>
										<input type="text" name="udName" required value="${deli.udName}">
									</td>
								</tr>
								<tr>
									<th>주소</th>
									<td>
										<input type="text" style="width: 30%" name="udAddressNum" readonly id="addr1" required value="${deli.udAddressNum}">
										<button type="button" class="btn_white search_btn" onclick="sample2_execDaumPostcode()">주소검색</button>
										<br>
										<input type="text" name="udAddress" readonly id="addr2" required value="${deli.udAddress}"> <br>
										<input type="text" name="udAddressEtc" id="addr3" value="${deli.udAddressEtc}">
									</td>
								</tr>
								<tr>
									<th>일반전화</th>
									<td>
										<input type="text" name="udTel" required value="${deli.udTel}">
									</td>
								</tr>
								<tr>
									<th>일반전화</th>
									<td>
										<input type="text" name="udPhone" required value="${deli.udPhone}">
									</td>
								</tr>
							</table>
						</div>
					...
					<div class="btn_menu">
						<button class="btnBold_w">배송지수정</button>
					</div>
				</form>
				<div class="order"></div>
