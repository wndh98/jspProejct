...
insert into MUNI_USER(USER_ID,USER_PASSWORD,USER_NAME,USER_PHONE,USER_EMAIL,USER_REGIST)
values ('admin','1234','관리자','010-1234-5678','admin@admin.com',sysdate);
-- 회원 배송지
...
CREATE TABLE BOARD_NOTICE(
    ...
    B_COUNT NUMBER NOT NULL,
    B_DATE DATE DEFAULT SYSDATE NOT NULL,
    CONSTRAINT PK_NT_B_NUM PRIMARY KEY(B_NUM),
    CONSTRAINT FK_NT_PI_NUM FOREIGN KEY(PI_NUM) REFERENCES PRODUCT_ITEM(PI_NUM),
    CONSTRAINT FK_NT_USER_ID FOREIGN KEY(USER_ID) REFERENCES MUNI_USER(USER_ID)
);
...
CREATE TABLE BOARD_FREE(
    ...
    B_COUNT NUMBER NOT NULL,
    B_DATE DATE DEFAULT SYSDATE NOT NULL,
    CONSTRAINT PK_FR_B_NUM PRIMARY KEY(B_NUM),
    CONSTRAINT FK_FR_PI_NUM FOREIGN KEY(PI_NUM) REFERENCES PRODUCT_ITEM(PI_NUM),
    CONSTRAINT FK_FR_USER_ID FOREIGN KEY(USER_ID) REFERENCES MUNI_USER(USER_ID)
);
