        ...
        <div id="container">
            ...
            <div class="product_item">
                <div class="product_img">
                    ...
                    <div class="product_sub_img">
                        <ul class="product_img_list">
                            ...
                            <li><img src="https://munigrabby.com/web/product/extra/small/202406/a82c4b729143db95e3247137745a6bd2.png"></li>
                            <li><img src="/images/product/product1.png"></li>
                        </ul>
                    </div>
                    <div class="zoomwrap">
                ...
                <div class="product_explain">
                    <form action="#none">
                        <input type="hidden" name="pi_num" value="">
                        <input type="hidden" name="pi_pirce" value="10000">
                        <input type="hidden" name="po_price" value="20000">
                        <h1>상품명</h1>
                        <div class="basic_info">
                            <ul>
                                <li><span>제목</span>설명</li>
                                <li><span>제목</span>설명</li>
                                <li><span>제목</span>설명</li>
                                <li><span>제목</span>설명</li>
                            </ul>
                        ...
                        <div class="product_option">
                            <div class="option_box">
                                <div class="option_title">옵션명</div>
                                <ul class="option_list">
                                    <li><button type="button" value="옵션1" price="10000">옵션1</button></li>
                                    <li><button type="button" value="옵션2" price="20000">옵션2</button></li>
                                    <li><button type="button" value="옵션3" price="30000"> 옵션3</button></li>
                                </ul>
                            </div>
                            <p>[필수] 옵션을 선택해 주세요.</p>
                            <span>(최소주문수량1개 이상)</span>
                        </div>
                        ...
                        <div class="product_select" style="display:none">
                            ...
                            <div class="info">
                                <p class="price">0원</p>
                                <p class="point">(<img src="/images/product/ico_product_point.gif">0원)</p>
                            </div>
                        </div>

                        <div class="product_price">
                            <div class="price_text"><span>TOTAL</span>(QUANTITY)</div>
                            <div class="price_info"><span id="price">0원</span><span id="count">(0개)</span></div>
                        </div>
                    ...
                    <div class="service_info">
                        <div class="service_block">
                            ...
                            <div class="detail">
                                ...
                                <p><br></p>
                                <p></p>    - 디지털 콘텐츠의 제공이 개시된 경우, (다만, 가분적 용역 또는 가분적 디지털콘텐츠로 구성된 계약의 경우 제공이 개시되지 아니한 부분은 청약철회를 할 수 있습니다.)
                                <p><br></p>
                                <p><br></p>
                                <p><br></p>
