			...
			<div class="board_content">
				<form action="/board/writeRV.do" method="post">
					<table class="boardForm">
						...
						<tr>
							<th>본문</th>
							<td><textarea rows="5" cols="40" style="width: 80%"
									name="bContent" required="required"></textarea> <!-- <div id="froala" style="height: 500px"></div> -->
							</td>
						</tr>
						<tr>
							<th>평점</th>
							<td><input type="radio" name="bStar" value="5" id="rate1"
								checked="checked"><label for="rate1">5★</label> <input
						...
						<tr>
							...
							<td><input type="radio" name="bScreate" id="setOpSe1"
								checked="checked" value="0"><label for="setOpSe1">공개글</label>
								<input type="radio" name="bScreate" id="setOpSe2" value="1"><label
